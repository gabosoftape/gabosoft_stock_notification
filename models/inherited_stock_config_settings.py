...
class ResConfigSettings(models.TransientModel):
	...
	notification_base = fields.Selection([('on_hand','Cantidades a la mano'),('fore_cast','Forecast')],related='company_id.notification_base',string='Notification Based On')
	notification_products = fields.Selection([('for_all','Global para todos los productos'),('fore_product',' Individual for all products')],related='company_id.notification_products',string='Min Quantity Based On')
